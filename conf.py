...
# -- PROJECT Variables ----------------------------------------------------
settings_project_name = "Standard per la rappresentazione XML e l\'identificazione univoca del patrimonio informativo di natura giuridica"
...
settings_basename = 'circ-normattiva'
settings_file_name = 'circ-normattiva'
